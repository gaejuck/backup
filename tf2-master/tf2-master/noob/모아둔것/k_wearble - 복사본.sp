...
new String:ShoseWearableConfig[120];
...
new WearableItems;
new Index = 0, Lv = 0, qual = 0, ItemIndex = 0;
...
#include "wearble/wearble_shose.sp"
...
//	RegConsoleCmd("sm_le", removemenu,"룩딸");
	BuildPath(Path_SM, HatWearableConfig, sizeof(HatWearableConfig), "configs/k_wearble/wearable-hat.cfg");
	BuildPath(Path_SM, ShoseWearableConfig, sizeof(ShoseWearableConfig), "configs/k_wearble/wearable-shose.cfg");
...
/*
public Action:removemenu(client, args)
{
