...
{
	if (!StrEqual(classname, "tf_projectile_ball_ornament", false))
	if (!StrEqual(classname, "tf_projectile_arrow", false))
	if (!StrEqual(classname, "tf_projectile_energy_ball", false))
	if (!StrEqual(classname, "tf_projectile_energy_ring", false))
	if (!StrEqual(classname, "tf_projectile_flare", false))
	if (!StrEqual(classname, "tf_projectile_healing_bolt", false))
	if (!StrEqual(classname, "tf_projectile_jar", false))
	if (!StrEqual(classname, "tf_projectile_jar_milk", false))
	...
	if (!StrEqual(classname, "tf_projectile_ball_ornament", false))
	if (!StrEqual(classname, "tf_projectile_cleaver", false))
